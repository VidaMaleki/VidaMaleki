...
- Developed backend API services and MongoDB schema models.
- Integrated frontend forms for seamless agent-renter communication.
- **Tech Stack:** Node.js, Nest.js, TypeScript, MongoDB, Jest, Cypress.

### [Microsoft Edge Browser - Sidebar Feature](https://github.com/VidaMaleki/Microsoft-Edge-Features)
Contributed to enhancing the Microsoft Edge browser with new features and accessibility improvements.
- Built the "Create New Scenario" feature to simplify Office file creation.
- Ensured accessibility through rigorous testing and best practices.
- **Tech Stack:** TypeScript, CSS, HTML, Fluent UI, C++.

### [Adies Capstone Hub](https://github.com/VidaMaleki/Adies_capstones_directory)
A platform for Ada Developers Academy students to showcase their capstone projects.
- Implemented secure authentication using JWT and Auth0.
- Created a dual-view platform for both students and visitors.
- **Tech Stack:** TypeScript, Next.js, Tailwind CSS, Prisma, PostgreSQL.

### [CashZar Website](http://cashzar-website.s3-website-us-west-2.amazonaws.com/)
A sleek, user-friendly website built for CashZar.
- Developed frontend components based on customized Google forms.
